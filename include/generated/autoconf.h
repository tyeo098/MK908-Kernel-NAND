...
#define CONFIG_RK_CPU_312_VOLT 900
...
#define CONFIG_CMDLINE "root=/dev/mtdblock2 console=ttyS2,115200 init=/sbin/init loglevel=8 rootfstype=ext4 rootwait mtdparts=rk29xxnand:0x00008000@0x00002000(boot),0x00008000@0x0000A000(kernel),-@0x00012000(system)"
...
#define CONFIG_DEFAULT_HOST_VERSION "omegamoon"
#define CONFIG_LLC 1
